...
class __TwigTemplate_a79b4161651d6a407c5ce6434767cc226bc4eafd9cf820dfb417544ce917cffd extends \Twig\Template
{
    ...
    {
        return new Source("{# inline_template_start #}<div class=\"permission\"><span class=\"title\">{{ title }}</span>{% if description or warning %}<div class=\"description\">{% if warning %}<em class=\"permission-warning\">{{ warning }}</em> {% endif %}{{ description }}</div>{% endif %}</div>", "__string_template__c49bd5ef621a21b509bb7e01331729d64d69e20c76562dd003290542cdb73e8b", "");
    }
}
