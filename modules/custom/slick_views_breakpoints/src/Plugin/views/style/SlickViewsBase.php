...
abstract class SlickViewsBase extends BlazyStylePluginBase {
  ...
  protected function buildSettingsForm(&$form, &$definition) {
    ...
    $title .= $this->t('Check Vanilla if using content/custom markups, not fields. <small>QA See it under <strong>Format > Show</strong> section. Otherwise slick markups apply which require some fields added below.</small>');
    $title .= '</p>';
